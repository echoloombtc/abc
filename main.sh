...
MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/kenDevXD/izinvps/ipuk/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
        TIMEDATE
    else
...
KYTPROJECT() {
    curl -sS https://raw.githubusercontent.com/kenDevXD/izinvps/ipuk/ip >/root/tmp
...
REPO="https://raw.githubusercontent.com/kenDevXD/abc/ipuk/"
CDNF="https://raw.githubusercontent.com/kenDevXD/abc/ipuk"
...
function finish(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/kenDevXD/izinvps/ipuk/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/kenDevXD/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
